...
// File contracts/nftMintContract.sol
...
contract nftMintContract is ERC721, ERC721Enumerable, NftsDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("NftsMint", "NFTM") {
    ...
    function mint() public payable{
        ...
        require(current < maxSupply, "No Nfts left :(");
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Nft #',
                tokenId.toString(),
                '", "description": "Those nfts are randomized Avataaars stored on chain to teach DApp development", "image": "',
                image,
                '"}'
            )
        );
